...
using Again_again.Models;
using Again_again.Data;
using Again_again.Filter;
using Again_again.Entities;
using Again_again.Authorization;
using Microsoft.AspNetCore.Authorization;

namespace Again_again.Controllers
{
    /// <summary>
    ...
    {
        private readonly Again_againContext _context;

        public RoleEntitlementController(Again_againContext context)
        {
            _context = context;
        }
