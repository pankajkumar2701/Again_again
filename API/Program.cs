...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "Again_again", Version = "v1" });
...
//Inject context
builder.Services.AddTransient<Again_againContext>();
...
if (app.Environment.IsDevelopment() || app.Environment.IsStaging() || app.Environment.IsProduction())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "Again_again API v1");
